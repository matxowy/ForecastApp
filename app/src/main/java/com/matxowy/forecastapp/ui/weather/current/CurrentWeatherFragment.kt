...
class CurrentWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun bindUI() = launch { // dziedziczymy po ScopedFragment dlatego możemy odpalić launch
    ...
    private fun updatePrecipitation(precipitationVolume: Double) {
        ...
        textView_precipitation.text = "Opady: $precipitationVolume$unitAbbreviation"
    }

    private fun updateWind(windDirection: String, windSpeed: Double) {
        val unitAbbreviation = chooseLocalizedUnitAbbreviation("kph","mph")
        textView_wind.text = "Wiatr: $windDirection, $windSpeed $unitAbbreviation"
    }

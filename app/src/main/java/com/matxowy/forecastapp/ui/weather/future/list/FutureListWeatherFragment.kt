...
class FutureListWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun updateDateToNextWeek() {
        (activity as? AppCompatActivity)?.supportActionBar?.subtitle = "Następny tydzień"
    }

    // Funkcja rozszerzająca liste pozwalająca zmapować UnitSpecificSimpleFutureWeatherEntry na listę FutureWeatherItem potrzebną do funkcji initRecycylerView
